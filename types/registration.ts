...
export const HOME_TESTIMONIALS = [
  ...
  },
  {
    ...
    name: 'بطة',
    role: 'طالبة',
    image: '/testimonials/batta-whatsapp.png',
    alt: 'رأي الطالبة بطة عن الكورس عبر واتساب',
  },
  {
    id: 3,
    name: 'خلود',
    role: 'طالبة',
    image: '/testimonials/khloud-whatsapp.png',
    alt: 'رأي الطالبة خلود عن الكورس عبر واتساب',
  },
  {
    id: 4,
    name: 'دعاء رشوان',
    role: 'طالبة',
    image: '/testimonials/doaa-whatsapp.png',
    alt: 'رأي الطالبة دعاء رشوان عن الكورس عبر واتساب',
  },
  {
    id: 5,
    name: 'نور محمد',
    role: 'طالبة',
    image: '/testimonials/nour-whatsapp.png',
    alt: 'رأي الطالبة نور محمد عن الكورس عبر واتساب',
  },
  {
    id: 6,
    name: 'جنى',
    role: 'طالبة',
    image: '/testimonials/jana-whatsapp.png',
    alt: 'رأي الطالبة جنى عن الكورس عبر واتساب',
  },
] as const
